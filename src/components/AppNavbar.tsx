      ...
      <header className="sticky top-0 z-50 w-full h-14 border-b border-border/30 bg-background/80 backdrop-blur-xl flex items-center px-4 sm:px-6 gap-4">
        ...
        <div className="lg:hidden flex items-center gap-3">
          ...
          <NavLink to="/" className="flex items-center gap-2">
            <img src={vsLogo} alt="VS SALES" className="h-7 w-7" />
            <span className="text-sm font-bold tracking-tight">VS SALES</span>
          </NavLink>
        </div>
            ...
            <div className="p-4 space-y-1">
              {allNavItems.map((item) => (
                <NavLink
                  ...
                  className="flex items-center gap-3 px-3 py-3 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-all"
