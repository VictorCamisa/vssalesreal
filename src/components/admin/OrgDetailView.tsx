  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={onBack}
          className="h-9 w-9 rounded-lg bg-[#1a1a2e] flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#252540] transition-colors"
        >
      ...
      {/* Sub-tabs */}
      <div className="flex gap-1 bg-[#0d0d18] rounded-xl p-1 border border-[#1a1a2e]">
        {subTabs.map(t => (
          <button
            key={t.key}
        ...
        loadingStats ? (
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              {[
                { label: "Leads", value: stats.leadsCount, icon: Users, color: "#00D4FF" },
                ...
                { label: "Conversas IA", value: stats.conversationsCount, icon: MessageCircle, color: "#0057FF" },
                ...
                { label: "Disparos", value: stats.broadcastsCount, icon: Radio, color: "#00D4FF" },
                ...
                <div key={card.label} className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-4">
            ...
            <div className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button onClick={() => setSubTab("ai")} className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#0057FF]/10 text-[#00D4FF] text-[11px] font-medium hover:bg-[#0057FF]/20 transition-colors border border-[#00D4FF]/20">
        ...
        loadingAi ? (
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button onClick={loadAiConfigs} className="flex items-center gap-1 text-[10px] text-gray-500 hover:text-[#00D4FF]">
            ...
            {aiConfigs.map(config => {
              ...
              return (
                <div key={config.id} className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
        ...
        loadingWa ? (
          ...
          <div className="space-y-3">
            ...
            {instances.map(inst => {
              ...
              return (
                <div key={inst.name} className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
          ...
          <div className="space-y-3">
            ...
            {broadcasts.map(b => {
              const statusColors: Record<string, string> = {
                draft: "#666", scheduled: "#FFB800", sending: "#00D4FF",
              ...
              return (
                <div key={b.id} className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {[
                      ...
                      <div key={m.label} className="text-center bg-[#0A0A14] rounded-lg p-2">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0057FF] text-white text-sm font-semibold hover:bg-[#0046CC] transition-colors disabled:opacity-50"
              >
            ...
            <div className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input value={companyProfile.company_name} onChange={e => setCompanyProfile(prev => prev ? { ...prev, company_name: e.target.value } : prev)} className="w-full h-9 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="Ex: VS Soluções" />
                </div>
                <div>
                  <label className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 block">Segmento</label>
                  <input value={companyProfile.segment || ""} onChange={e => setCompanyProfile(prev => prev ? { ...prev, segment: e.target.value } : prev)} className="w-full h-9 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="Ex: Tecnologia B2B" />
                </div>
                <div>
                  <label className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 block">CNPJ</label>
                  <input value={companyProfile.cnpj || ""} onChange={e => setCompanyProfile(prev => prev ? { ...prev, cnpj: e.target.value } : prev)} className="w-full h-9 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="00.000.000/0000-00" />
                </div>
                <div>
                  <label className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 block">Ano de Fundação</label>
                  <input type="number" value={companyProfile.founded_year || ""} onChange={e => setCompanyProfile(prev => prev ? { ...prev, founded_year: e.target.value ? Number(e.target.value) : null } : prev)} className="w-full h-9 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="2020" />
                </div>
              </div>
              <div>
                <label className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 block">Descrição</label>
                <textarea rows={3} value={companyProfile.description} onChange={e => setCompanyProfile(prev => prev ? { ...prev, description: e.target.value } : prev)} className="w-full px-3 py-2 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30 resize-none" placeholder="O que a empresa faz..." />
              </div>
            </div>
            ...
            <div className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-5 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setCompanyProfile(prev => prev ? { ...prev, products_services: [...prev.products_services, { name: "", description: "", price: "" }] } : prev)} className="flex items-center gap-1 text-[10px] text-[#00D4FF] hover:text-white transition-colors">
              ...
              {companyProfile.products_services.map((product, idx) => (
                <div key={idx} className="p-3 rounded-lg border border-[#1a1a2e] bg-[#0A0A14]/50 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <input value={product.name} onChange={e => { const updated = [...companyProfile.products_services]; (updated[idx] as any).name = e.target.value; setCompanyProfile(prev => prev ? { ...prev, products_services: updated } : prev); }} className="h-8 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-xs text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="Nome" />
                    <input value={product.price || ""} onChange={e => { const updated = [...companyProfile.products_services]; (updated[idx] as any).price = e.target.value; setCompanyProfile(prev => prev ? { ...prev, products_services: updated } : prev); }} className="h-8 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-xs text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="Preço" />
                  </div>
                  <textarea rows={2} value={product.description} onChange={e => { const updated = [...companyProfile.products_services]; (updated[idx] as any).description = e.target.value; setCompanyProfile(prev => prev ? { ...prev, products_services: updated } : prev); }} className="w-full px-3 py-2 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-xs text-white focus:outline-none focus:border-[#00D4FF]/30 resize-none" placeholder="Descrição" />
                </div>
              ))}
            </div>
            ...
            <div className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-5 space-y-4">
              ...
              {[
                ...
                <div key={f.field}>
                  ...
                  <textarea rows={2} value={(companyProfile as any)[f.field] || ""} onChange={e => setCompanyProfile(prev => prev ? { ...prev, [f.field]: e.target.value } : prev)} className="w-full px-3 py-2 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30 resize-none" placeholder={f.placeholder} />
                </div>
              ))}
            </div>
            ...
            <div className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={f.field}>
                    <label className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 block">{f.label}</label>
                    <input value={(companyProfile as any)[f.field] || ""} onChange={e => setCompanyProfile(prev => prev ? { ...prev, [f.field]: e.target.value } : prev)} className="w-full h-9 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder={f.placeholder} />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-xl border border-[#1a1a2e] bg-[#0d0d18]/60 p-5 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setCompanyProfile(prev => prev ? { ...prev, objections_faq: [...prev.objections_faq, { question: "", answer: "" }] } : prev)} className="flex items-center gap-1 text-[10px] text-[#00D4FF] hover:text-white transition-colors">
                  <Plus className="h-3 w-3" /> Adicionar
                </button>
              </div>
              ...
              {companyProfile.objections_faq.map((faq, idx) => (
                <div key={idx} className="p-3 rounded-lg border border-[#1a1a2e] bg-[#0A0A14]/50 space-y-2">
                  ...
                  <input value={faq.question} onChange={e => { const updated = [...companyProfile.objections_faq]; updated[idx].question = e.target.value; setCompanyProfile(prev => prev ? { ...prev, objections_faq: updated } : prev); }} className="w-full h-8 px-3 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-xs text-white focus:outline-none focus:border-[#00D4FF]/30" placeholder="Objeção" />
                  <textarea rows={2} value={faq.answer} onChange={e => { const updated = [...companyProfile.objections_faq]; updated[idx].answer = e.target.value; setCompanyProfile(prev => prev ? { ...prev, objections_faq: updated } : prev); }} className="w-full px-3 py-2 rounded-lg bg-[#0A0A14] border border-[#1a1a2e] text-xs text-white focus:outline-none focus:border-[#00D4FF]/30 resize-none" placeholder="Resposta" />
                </div>
              ))}
            </div>
          </div>
