...
export default function AdminAuth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: "#06060B" }}>
      ...
      {/* Glow orbs */}
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-[#0057FF]/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-[#00D4FF]/8 rounded-full blur-[100px]" />
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#00D4FF] font-semibold">Área Restrita</span>
          </div>
          <h1
        ...
        {/* Form Card */}
        <div className="rounded-2xl border border-[#1a1a2e] bg-[#0d0d18]/80 backdrop-blur-xl p-8 shadow-[0_0_60px_rgba(0,87,255,0.08)]">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full h-11 pl-10 pr-4 rounded-xl bg-[#0A0A14] border border-[#1a1a2e] text-sm text-white placeholder:text-gray-700 focus:outline-none focus:border-[#00D4FF]/50 focus:shadow-[0_0_20px_rgba(0,212,255,0.1)] transition-all"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 rounded-xl bg-gradient-to-r from-[#0057FF] to-[#00D4FF] text-sm font-semibold text-white hover:shadow-[0_0_30px_rgba(0,212,255,0.3)] transition-all duration-300 disabled:opacity-50"
            >
              {loading ? (
