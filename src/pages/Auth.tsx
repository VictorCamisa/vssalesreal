      ...
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight">Vendas AI</h1>
            <p className="text-sm text-muted-foreground mt-1.5">Sales Intelligence & CRM</p>
          </div>
        </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-11 rounded-xl bg-secondary/50 border-border/50 focus:border-primary/50"
                    required
                  />
                </div>
              </div>
